...
export const mockPendingList: PendingAuditItem[] = [
  {
    orderId: 'AUD001',
    question: '更换手机号收不到验证码怎么办',
    confidence: 0.62,
    submitTime: '2026-07-08 09:22',
  },
  {
    orderId: 'AUD002',
    question: '优惠券无法正常核销',
    confidence: 0.83,
    submitTime: '2026-07-08 10:15',
  },
  {
    orderId: 'AUD003',
    question: '提现一直处于审核状态',
    confidence: 0.57,
    submitTime: '2026-07-08 11:36',
  },
  {
    orderId: 'AUD004',
    question: '购物地址修改失败',
    confidence: 0.74,
    submitTime: '2026-07-09 08:42',
  },
]
...
export const mockCategoryTree: CategoryItem[] = [
  ...
  },
  {
    ...
    label: '订单支付类',
    parentId: null,
    children: [{ id: 'c2-1', label: '重复扣款', parentId: 'c2' }],
  },
...
// 严格类型映射，消除any
type MockUrlKey =
  '/workbench/users' | '/knowledge/list' | '/knowledge/categoryTree' | '/audit/pending'

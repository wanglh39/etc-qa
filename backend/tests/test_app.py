...
class TestCreateService:
    ...
    def test_create_service_initializes(self, mock_load_cfg, mock_validate, mock_mysql_cls, mock_milvus_cls,
                                         mock_embed, mock_rerank, mock_wo_cls):
        mock_load_cfg.return_value = {
            ...
            "models": {"embed": {"name": "BAAI/bge-large-zh-v1.5", "dim": 1024, "api_base": "https://api.siliconflow.cn/v1", "api_keys": "k1,k2"}, "rerank": {"name": "BAAI/bge-reranker-v2-m3", "api_base": "https://api.siliconflow.cn/v1", "api_keys": "k1,k2"}, "query_prefix": ""},
